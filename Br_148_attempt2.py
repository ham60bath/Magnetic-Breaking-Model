# -*- coding: utf-8 -*-
"""
Created on Mon Apr 12 15:54:03 2021
...
data = pd.read_excel('C:/Users/harry/OneDrive/Documents/Uni/Y2/S2/Labs/Br graphs/Br_148_attempt2.xlsx' , 
                        names=('time', 'w'), 
                        usecols=(0,1), 
                        nrows = 673)
...
sig=16.4*(10**6);R=0.045;S=1.01*(10**-3);d=2*(10**-3); B = 86 *10**-3
