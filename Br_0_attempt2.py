# -*- coding: utf-8 -*-
"""
Created on Mon Apr 26 11:00:51 2021
...
data = pd.read_excel('C:/Users/harry/OneDrive/Documents/Uni/Y2/S2/Labs/Br graphs/Br_0_attempt2.xlsx' , 
                        names=('time', 'w'), 
                        usecols=(0,1), 
                        nrows = 1000)
...
while(i<637):
    val=data.w[i]
    t=data.time[i]
    if(val-20<test(t) and test(t)<val+5):
        newt.append(t)
        neww.append(val)
        
    i=i+1
#plt.plot(data.time, test(data.time), color = 'blue')
plt.scatter(newt,neww,label="Data Points")

#~~~~~~~~~~~~~~~~~~~Defining variables~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#m = mass of the disk, r = radius of the disk
#m = mass of the disk, r = radius of the disk
m=0.5304 ; r=0.3; I=0.5*m*r**2
sig=16.4*(10**6);R=0.28;S=1.01*(10**-3);d=2*(10**-3); B = 208 *10**-3

Ti= 0

print(Ti)

Tc =0.013925321272989826; Tp=0.0003489384017704766
...
#plt.plot(T, str_line(T,*popt),"y",label="Curve Fit")
