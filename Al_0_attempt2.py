# -*- coding: utf-8 -*-
"""
Created on Mon Apr 19 20:24:52 2021
...
data = pd.read_excel('C:/Users/harry/OneDrive/Documents/Uni/Y2/S2/Labs/Al graphs/AL_0_attempt2.xlsx' , 
                        names=('time', 'w'), 
                        usecols=(0,1), 
                        nrows = 1000)
...
while(i<558):
    val=data.w[i]
    t=data.time[i]
    if(val-15<test(t) and test(t)<val+20):
        newt.append(t)
        neww.append(val)
...
i= 0.170; Tc = 0.01 ;
sig=42.3*(10**6);R=0.28;S=1.01*(10**-3);d=2*(10**-3); B = 210 *10**-3

Ti= 0

print(I)

Tc =0.010884254219615192; Tp=0.0003487009256033188
