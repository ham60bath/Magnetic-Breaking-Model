# -*- coding: utf-8 -*-
"""
Created on Fri Apr 23 11:49:04 2021
...
data = pd.read_excel('C:/Users/harry/OneDrive/Documents/Uni/Y2/S2/Labs/Al_th graphs/Al_th_0_attempt1.xlsx' , 
                        names=('time', 'w'), 
                        usecols=(0,1), 
                        nrows = 1000)
...
while(i<732):
    val=data.w[i]
    t=data.time[i]
    if(val-20<test(t) and test(t)<val+9):
        newt.append(t)
        neww.append(val)
...
#plt.errorbar(newt, neww, yerr = 5, capsize = 0)

#~~~~~~~~~~~~~~~~~~~Defining variables~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#m = mass of the disk, r = radius of the disk
#m = mass of the disk, r = radius of the disk
m=0.407 ; r=0.3; I=0.5*m*r**2
...
Tc = 0.01428391424237298; Tp=0.0003382375472614181
