...
a=222.688;b=-0.442;c=-7.700;

def test(x):
    return a*np.exp(b*x)+c

data = pd.read_excel('C:/Users/harry/OneDrive/Documents/Uni/Y2/S2/Labs/Al graphs/AL_398_attempt2.xlsx' , 
                        names=('time', 'w'), 
                        usecols=(0,1), 
                        nrows = 1000)
...
sig=42.1*(10**6);R=0.05;S=1.01*(10**-3);d=1*(10**-3); B = 210 *10**-3
...
print("exp factor= {0:5.3f} +/- {1:5.3f}".format(popt[1] * I,pcov[1,1]**0.5))
