...
data = pd.read_excel('C:/Users/harry/OneDrive/Documents/Uni/Y2/S2/Labs/Br graphs/Br_398_attempt2.xlsx' , 
                        names=('time', 'w'), 
                        usecols=(0,1), 
                        nrows = 1000)
...
sig=16.4*(10**6);R=0.041;S=1.01*(10**-3);d=2*(10**-3); B = 208 *10**-3
