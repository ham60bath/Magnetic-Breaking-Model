# -*- coding: utf-8 -*-
"""
Created on Fri Apr 23 13:00:34 2021
...
data = pd.read_excel('C:/Users/harry/OneDrive/Documents/Uni/Y2/S2/Labs/Al_th graphs/Al_th_398_attempt2.xlsx' , 
                        names=('time', 'w'), 
                        usecols=(0,1), 
                        nrows = 1000)
...
sig=16.4*(10**6);R=0.11;S=1.01*(10**-3);d=2*(10**-3); B = 208 *10**-3

Ti= sig * R * R * S *B*B* d * 0.90
